...
| File | Format | For |
|:---|:---|:---|
| {/* llms:docslink;path=mobiscroll-react.mdc */}{/* /llms:docslink */}<DocsLink path="mobiscroll-react.mdc" download /> | Cursor rule file | Cursor |
| {/* llms:docslink;path=copilot-instructions/mobiscroll-react.instructions.md */}{/* /llms:docslink */}<DocsLink path="copilot-instructions/mobiscroll-react.instructions.md" download /> | Copilot instruction file | GitHub Copilot |
...
| Framework | Name | URL |
|:---|:---|:---|
| React | Mobiscroll React | {/* llms:docsurl;path=llms-react-full.txt */}<DocsUrl path="llms-react-full.txt" /> |
...
Download the {/* llms:docslink;path=mobiscroll-react.mdc */}<DocsLink path="mobiscroll-react.mdc" download><code>mobiscroll-react.mdc</code></DocsLink>{/* /llms:docslink */} file and place it in `.cursor/rules/`:
...
Download the {/* llms:docslink;path=copilot-instructions/mobiscroll-react.instructions.md */}<DocsLink path="copilot-instructions/mobiscroll-react.instructions.md" download><code>mobiscroll-react.instructions.md</code></DocsLink>{/* /llms:docslink */} file and place it in `.github/instructions/`:
...
| File | URL |
|:---|:---|
| React | {/* llms:docsurl;path=llms-react-full.txt */}<DocsUrl path="llms-react-full.txt" /> |

### Rules files

| File | Cursor (`.mdc`) | Copilot (`.instructions.md`) |
|:---|:---|:---|
| React rules | {/* llms:docslink;path=mobiscroll-react.mdc */}{/* /llms:docslink */}<DocsLink path="mobiscroll-react.mdc" download /> | {/* llms:docslink;path=copilot-instructions/mobiscroll-react.instructions.md */}{/* /llms:docslink */}<DocsLink path="copilot-instructions/mobiscroll-react.instructions.md" download /> |
...
{/* llms:fileblock;src=docs/react/SKILL.md */}
<FileBlock src="docs/react/SKILL.md" />
</details>
...
{/* llms:fileblock;src=mobiscroll-react.mdc */}
