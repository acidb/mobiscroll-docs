...
| File | Format | For |
|:---|:---|:---|
| <DocsLink path="5.35.0/mobiscroll-react.mdc" download /> | Cursor rule file | Cursor |
| <DocsLink path="5.35.0/copilot-instructions/mobiscroll-react.instructions.md" download /> | Copilot instruction file | GitHub Copilot |
...
| <DocsLink path="docs/react/SKILL.md" download filename="mobiscroll-ui-react.mdc">mobiscroll-ui-react.mdc</DocsLink> | Cursor extended rule (React) | Cursor |
...
| <DocsLink path="copilot-instructions/mobiscroll-ui-react.instructions.md" download>mobiscroll-ui-react.instructions.md</DocsLink> | Copilot extended instruction (React) | GitHub Copilot |
...
| Framework | Name | URL |
|:---|:---|:---|
| React | Mobiscroll React | <DocsUrl path="5.35.0/llms-react-full.txt" /> |
...
Download the <DocsLink path="5.35.0/mobiscroll-react.mdc" download><code>mobiscroll-react.mdc</code></DocsLink> file and place it in `.cursor/rules/`:
...
- <DocsLink path="docs/react/SKILL.md" download filename="mobiscroll-ui-react.mdc">mobiscroll-ui-react.mdc (React conventions)</DocsLink>
...
Download the <DocsLink path="5.35.0/copilot-instructions/mobiscroll-react.instructions.md" download><code>mobiscroll-react.instructions.md</code></DocsLink> file and place it in `.github/instructions/`:
...
- <DocsLink path="copilot-instructions/mobiscroll-ui-react.instructions.md" download>mobiscroll-ui-react.instructions.md (React conventions)</DocsLink>
...
| File | URL |
|:---|:---|
| React | <DocsUrl path="5.35.0/llms-react-full.txt" /> |

### Rules files

| File | Cursor (`.mdc`) | Copilot (`.instructions.md`) |
|:---|:---|:---|
| React rules | <DocsLink path="5.35.0/mobiscroll-react.mdc" download /> | <DocsLink path="5.35.0/copilot-instructions/mobiscroll-react.instructions.md" download /> |
...
| React conventions | <DocsLink path="docs/react/SKILL.md" download filename="mobiscroll-ui-react.mdc"><code>mobiscroll-ui-react.mdc</code></DocsLink> | <DocsLink path="copilot-instructions/mobiscroll-ui-react.instructions.md" download /> |
...
<FileBlock src="5.35.0/mobiscroll-react.mdc" />
</details>
