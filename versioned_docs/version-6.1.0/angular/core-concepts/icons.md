...
title: Icons
description: 'Browse and use the built-in Mobiscroll icon set in Angular components, or register custom icon fonts and SVGs.'
---
...
## Use Mobiscroll icons in Ionic components {#use-mobiscroll-icons-in-ionic-components}
...
## Use external icons in Mobiscroll components {#use-external-icons-in-mobiscroll-components}
