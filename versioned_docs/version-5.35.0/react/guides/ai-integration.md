...
description: 'Set up AI coding assistants — Claude Code, Codex, Cursor, and GitHub Copilot — with Mobiscroll React docs and behavior rules to generate accurate, framework-specific component code.'
---
...
| File | Format | For |
|:---|:---|:---|
| {/* llms:docslink;path=5.35.0/mobiscroll-react.mdc */}{/* /llms:docslink */}<DocsLink path="5.35.0/mobiscroll-react.mdc" download /> | Cursor rule file | Cursor |
| {/* llms:docslink;path=5.35.0/copilot-instructions/mobiscroll-react.instructions.md */}{/* /llms:docslink */}<DocsLink path="5.35.0/copilot-instructions/mobiscroll-react.instructions.md" download /> | Copilot instruction file | GitHub Copilot |
...
| {/* llms:docslink;path=docs/react/SKILL.md;filename=mobiscroll-ui-react.mdc */}<DocsLink path="docs/react/SKILL.md" download filename="mobiscroll-ui-react.mdc">mobiscroll-ui-react.mdc</DocsLink>{/* /llms:docslink */} | Cursor extended rule (React) | Cursor |
...
| {/* llms:docslink;path=copilot-instructions/mobiscroll-ui-react.instructions.md */}<DocsLink path="copilot-instructions/mobiscroll-ui-react.instructions.md" download>mobiscroll-ui-react.instructions.md</DocsLink>{/* /llms:docslink */} | Copilot extended instruction (React) | GitHub Copilot |
...
| Framework | Name | URL |
|:---|:---|:---|
| React | Mobiscroll React | {/* llms:docsurl;path=5.35.0/llms-react-full.txt */}<DocsUrl path="5.35.0/llms-react-full.txt" /> |
...
Download the {/* llms:docslink;path=5.35.0/mobiscroll-react.mdc */}<DocsLink path="5.35.0/mobiscroll-react.mdc" download><code>mobiscroll-react.mdc</code></DocsLink>{/* /llms:docslink */} file and place it in `.cursor/rules/`:
...
- {/* llms:docslink;path=docs/react/SKILL.md;filename=mobiscroll-ui-react.mdc */}<DocsLink path="docs/react/SKILL.md" download filename="mobiscroll-ui-react.mdc">mobiscroll-ui-react.mdc (React conventions)</DocsLink>{/* /llms:docslink */}
...
Download the {/* llms:docslink;path=5.35.0/copilot-instructions/mobiscroll-react.instructions.md */}<DocsLink path="5.35.0/copilot-instructions/mobiscroll-react.instructions.md" download><code>mobiscroll-react.instructions.md</code></DocsLink>{/* /llms:docslink */} file and place it in `.github/instructions/`:
...
- {/* llms:docslink;path=copilot-instructions/mobiscroll-ui-react.instructions.md */}<DocsLink path="copilot-instructions/mobiscroll-ui-react.instructions.md" download>mobiscroll-ui-react.instructions.md (React conventions)</DocsLink>{/* /llms:docslink */}
...
**Fix:** Verify that you have the correct rules file in place. For React in Cursor, use `mobiscroll-react.mdc`; for Copilot, use `mobiscroll-react.instructions.md`. In Cursor, check that the registered @docs source points to `5.35.0/llms-react-full.txt`.
...
| File | URL |
|:---|:---|
| React | {/* llms:docsurl;path=5.35.0/llms-react-full.txt */}<DocsUrl path="5.35.0/llms-react-full.txt" /> |

### Rules files

| File | Cursor (`.mdc`) | Copilot (`.instructions.md`) |
|:---|:---|:---|
| React rules | {/* llms:docslink;path=5.35.0/mobiscroll-react.mdc */}{/* /llms:docslink */}<DocsLink path="5.35.0/mobiscroll-react.mdc" download /> | {/* llms:docslink;path=5.35.0/copilot-instructions/mobiscroll-react.instructions.md */}{/* /llms:docslink */}<DocsLink path="5.35.0/copilot-instructions/mobiscroll-react.instructions.md" download /> |
...
| React conventions | {/* llms:docslink;path=docs/react/SKILL.md;filename=mobiscroll-ui-react.mdc */}<DocsLink path="docs/react/SKILL.md" download filename="mobiscroll-ui-react.mdc"><code>mobiscroll-ui-react.mdc</code></DocsLink>{/* /llms:docslink */} | {/* llms:docslink;path=copilot-instructions/mobiscroll-ui-react.instructions.md */}{/* /llms:docslink */}<DocsLink path="copilot-instructions/mobiscroll-ui-react.instructions.md" download /> |
...
<details>
<summary>View <code>mobiscroll-ui-react.mdc</code> (React conventions)</summary>
{/* llms:fileblock;src=docs/react/SKILL.md */}<FileBlock src="docs/react/SKILL.md" />
</details>
...
{/* llms:fileblock;src=5.35.0/mobiscroll-react.mdc */}<FileBlock src="5.35.0/mobiscroll-react.mdc" />
</details>
