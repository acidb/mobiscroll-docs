...
applyTo: "**"
---
# Mobiscroll for JavaScript — AI Rules (v5)

## Documentation Source

- **Primary (complete v5 docs):** {{DOCS_BASE_URL}}/5.35.0/llms-javascript-full.txt
- **TOC (links to .md pages):** {{DOCS_BASE_URL}}/5.35.0/llms-javascript.txt
- **Individual pages:** `{{DOCS_BASE_URL}}/javascript/{section}/{page}.md`
- **Icons (supplementary):** {{DOCS_BASE_URL}}/5.35.0/llms-icons.txt

## Scope

USE this file when:
- Project has `@mobiscroll/javascript` in package.json **and is on Mobiscroll v5**
- Code uses `import * as mobiscroll from '@mobiscroll/javascript'` or named imports from that package
- User explicitly mentions plain/vanilla JavaScript + Mobiscroll v5

DO NOT use this file for React, Angular, Vue, or jQuery projects.
DO NOT use this file for Mobiscroll v6 projects — use `mobiscroll-javascript.mdc` instead.
...
- Fetch `5.35.0/llms-javascript-full.txt` for complete v5 context
