...
description: 'Step-by-step guide for migrating from FullCalendar to Mobiscroll Eventcalendar in JavaScript — API mapping, event model, and config comparison.'
---
