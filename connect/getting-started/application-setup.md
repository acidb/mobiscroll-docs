...
Head over to the [pricing page](https://mobiscroll.com/connect-pricing) and choose the plan that suits you the best. After your subscription is started, the [Mobiscroll Connect dashboard](https://app.mobiscroll.com/connect) will become available.
...
1. Navigate to the **[Connect dashboard](https://app.mobiscroll.com/connect)** tab on your account page.
...
:::info
Branding is available on the **Scale** plan or higher. On lower plans the Connect screens use the default Mobiscroll branding.
:::
