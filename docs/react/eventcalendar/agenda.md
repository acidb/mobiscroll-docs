...
Check out how you can style the header in [this example](https://demo.mobiscroll.com/react/agenda/customizing-day-header#) or just play with the slider below to see the differences.
