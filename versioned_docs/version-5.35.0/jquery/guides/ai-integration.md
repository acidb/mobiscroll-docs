...
| File | Format | For |
|:---|:---|:---|
| <DocsLink path="5.35.0/mobiscroll-jquery.mdc" download /> | Cursor rule file | Cursor, GitHub Copilot |
...
| Framework | Name | URL |
|:---|:---|:---|
| jQuery | Mobiscroll jQuery | <DocsUrl path="5.35.0/llms-jquery-full.txt" /> |
...
Download the <DocsLink path="5.35.0/mobiscroll-jquery.mdc" download><code>mobiscroll-jquery.mdc</code></DocsLink> file and place it at the root of your project, or copy [its content](#rules-files-mdc) into your `.github/` instruction files:
...
<FileBlock src="5.35.0/mobiscroll-jquery.mdc" />
</details>
