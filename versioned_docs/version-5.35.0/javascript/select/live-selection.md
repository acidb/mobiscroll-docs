...
description: 'Enable live selection in the Mobiscroll Select for JavaScript — fires change immediately as the user scrolls through options, before confirmation.'
---
