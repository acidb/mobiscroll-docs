...
Download the <DocsLink path="mobiscroll-javascript.mdc" download><code>mobiscroll-javascript.mdc</code></DocsLink> file for your framework and place it at the root of your project or alternatively copy it's content to the rules files under the `.github/` directory:
