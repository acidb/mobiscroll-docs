...
description: 'Mobiscroll Vue utility functions for date formatting, parsing, timezone conversion, and calendar math — API reference and examples.'
---
...
```jsx
import { platform } from '@mobiscroll/vue';
```
...
```jsx
import { parseDate } from '@mobiscroll/vue';
```
