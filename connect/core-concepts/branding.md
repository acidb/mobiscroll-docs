...
- **Logo**: a square logo (recommended 128x128) shown on the Connect screens. Upload a file (PNG, JPG, WebP, or SVG - optimized and hosted for you) or paste your own hosted image URL. Defaults to the Mobiscroll logo.
