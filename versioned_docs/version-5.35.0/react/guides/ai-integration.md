...
| File | Format | For |
|:---|:---|:---|
| <DocsLink path="5.35.0/mobiscroll-react.mdc" download /> | Cursor rule file | Cursor, GitHub Copilot |
| `mobiscroll-ui/SKILL.md` + `docs/react/SKILL.md` + `mobiscroll-ui-theming/SKILL.md` | Claude Code skills | Cursor, GitHub Copilot, Claude Code (via plugin) |
...
|:---|:---|:---|
| **Cursor** | `llms-react-full.txt` via @docs | `.mdc` file or `SKILL.md` files |
...
- <DocsLink path="docs/react/SKILL.md" download>mobiscroll-ui-react SKILL.md (React conventions)</DocsLink>
...
Download the <DocsLink path="5.35.0/mobiscroll-react.mdc" download><code>mobiscroll-react.mdc</code></DocsLink> file and place it at the root of your project, or copy [its content](#rules-files-mdc) into your `.github/` instruction files:
...
| React conventions skill | <DocsLink path="docs/react/SKILL.md" download /> |
