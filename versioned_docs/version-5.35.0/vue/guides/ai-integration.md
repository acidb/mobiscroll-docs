...
|   └── instructions/
|       └── vue-logic.instructions.md <-- Specific rules
├── src/
├── package.json
└── ...
```
...
If you don't already have a `CLAUDE.md` in your project root, download <DocsLink path="5.35.0/vue/CLAUDE.md" download><code>CLAUDE.md</code></DocsLink> and place it there. If you already have one, copy the contents into your existing file instead — see [File contents](#file-contents) below.
...
| File | URL |
|:---|:---|
| Claude Code context | <DocsLink path="5.35.0/vue/CLAUDE.md" download /> |
...
<FileBlock src="5.35.0/vue/CLAUDE.md" />
</details>
