...
description: 'Complete API reference for the Mobiscroll Popup in Vue — all options, methods, lifecycle events, and types.'
---
...
## Slots
The display of the Popup component can be customized with different template slots.
