...
Download the <DocsLink path="mobiscroll-angular.mdc" download><code>mobiscroll-angular.mdc</code></DocsLink> file for your framework and place it in your project's `.cursor/rules/` directory:
