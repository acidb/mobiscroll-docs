...
description: 'Set up AI coding assistants — Claude Code, Codex, Cursor, and GitHub Copilot — with Mobiscroll JavaScript docs and behavior rules to generate accurate, framework-specific component code.'
---
...
- **Mix frameworks** — add React hooks or Angular module imports to plain JavaScript code
- **Reference outdated versions** — generate v5 code when the current version is v6
- **Ignore framework conventions** — skip the CSS import or use component-based initialization instead of the JavaScript API
...
| `llms-javascript.txt` | JavaScript table of contents (links to individual pages) |
...
| File | Format | For |
|:---|:---|:---|
| {/* llms:docslink;path=5.35.0/mobiscroll-javascript.mdc */}{/* /llms:docslink */}<DocsLink path="5.35.0/mobiscroll-javascript.mdc" download /> | Cursor rule file | Cursor |
| {/* llms:docslink;path=5.35.0/copilot-instructions/mobiscroll-javascript.instructions.md */}{/* /llms:docslink */}<DocsLink path="5.35.0/copilot-instructions/mobiscroll-javascript.instructions.md" download /> | Copilot instruction file | GitHub Copilot |
...
| {/* llms:docslink;path=docs/javascript/SKILL.md;filename=mobiscroll-ui-javascript.mdc */}<DocsLink path="docs/javascript/SKILL.md" download filename="mobiscroll-ui-javascript.mdc">mobiscroll-ui-javascript.mdc</DocsLink>{/* /llms:docslink */} | Cursor extended rule (JavaScript) | Cursor |
...
| {/* llms:docslink;path=copilot-instructions/mobiscroll-ui-javascript.instructions.md */}<DocsLink path="copilot-instructions/mobiscroll-ui-javascript.instructions.md" download>mobiscroll-ui-javascript.instructions.md</DocsLink>{/* /llms:docslink */} | Copilot extended instruction (JavaScript) | GitHub Copilot |
...
|:---|:---|:---|
| **Cursor** | Option A | `mobiscroll-javascript.mdc` |
...
| Framework | Name | URL |
|:---|:---|:---|
| JavaScript | Mobiscroll JavaScript | {/* llms:docsurl;path=5.35.0/llms-javascript-full.txt */}<DocsUrl path="5.35.0/llms-javascript-full.txt" /> |
...
Download the {/* llms:docslink;path=5.35.0/mobiscroll-javascript.mdc */}<DocsLink path="5.35.0/mobiscroll-javascript.mdc" download><code>mobiscroll-javascript.mdc</code></DocsLink>{/* /llms:docslink */} file and place it in `.cursor/rules/`:

```
your-project/
├── .cursor/
│   └── rules/
│       └── mobiscroll-javascript.mdc
├── src/
└── package.json
```
...
- {/* llms:docslink;path=docs/javascript/SKILL.md;filename=mobiscroll-ui-javascript.mdc */}<DocsLink path="docs/javascript/SKILL.md" download filename="mobiscroll-ui-javascript.mdc">mobiscroll-ui-javascript.mdc (JavaScript conventions)</DocsLink>{/* /llms:docslink */}
...
Download the {/* llms:docslink;path=5.35.0/copilot-instructions/mobiscroll-javascript.instructions.md */}<DocsLink path="5.35.0/copilot-instructions/mobiscroll-javascript.instructions.md" download><code>mobiscroll-javascript.instructions.md</code></DocsLink>{/* /llms:docslink */} file and place it in `.github/instructions/`:

```
your-project/
├── .github/
|   └── instructions/
|       └── mobiscroll-javascript.instructions.md
├── src/
└── package.json
```
...
- {/* llms:docslink;path=copilot-instructions/mobiscroll-ui-javascript.instructions.md */}<DocsLink path="copilot-instructions/mobiscroll-ui-javascript.instructions.md" download>mobiscroll-ui-javascript.instructions.md (JavaScript conventions)</DocsLink>{/* /llms:docslink */}
...
|       ├── mobiscroll-ui-javascript.instructions.md
...
**Symptom:** You are using JavaScript but the AI generates code for a different framework (e.g. `import { Eventcalendar } from '@mobiscroll/react'`).

**Fix:** Verify that you have the correct rules file in place. For JavaScript in Cursor, use `mobiscroll-javascript.mdc`; for Copilot, use `mobiscroll-javascript.instructions.md`. In Cursor, check that the registered @docs source points to `5.35.0/llms-javascript-full.txt`.
...
| File | URL |
|:---|:---|
| JavaScript | {/* llms:docsurl;path=5.35.0/llms-javascript-full.txt */}<DocsUrl path="5.35.0/llms-javascript-full.txt" /> |

### Rules files

| File | Cursor (`.mdc`) | Copilot (`.instructions.md`) |
|:---|:---|:---|
| JavaScript rules | {/* llms:docslink;path=5.35.0/mobiscroll-javascript.mdc */}{/* /llms:docslink */}<DocsLink path="5.35.0/mobiscroll-javascript.mdc" download /> | {/* llms:docslink;path=5.35.0/copilot-instructions/mobiscroll-javascript.instructions.md */}{/* /llms:docslink */}<DocsLink path="5.35.0/copilot-instructions/mobiscroll-javascript.instructions.md" download /> |
...
| JavaScript conventions | {/* llms:docslink;path=docs/javascript/SKILL.md;filename=mobiscroll-ui-javascript.mdc */}<DocsLink path="docs/javascript/SKILL.md" download filename="mobiscroll-ui-javascript.mdc"><code>mobiscroll-ui-javascript.mdc</code></DocsLink>{/* /llms:docslink */} | {/* llms:docslink;path=copilot-instructions/mobiscroll-ui-javascript.instructions.md */}{/* /llms:docslink */}<DocsLink path="copilot-instructions/mobiscroll-ui-javascript.instructions.md" download /> |
...
{/* llms:fileblock;src=docs/javascript/SKILL.md */}<FileBlock src="docs/javascript/SKILL.md" />
</details>
...
{/* llms:fileblock;src=5.35.0/mobiscroll-javascript.mdc */}<FileBlock src="5.35.0/mobiscroll-javascript.mdc" />
</details>
