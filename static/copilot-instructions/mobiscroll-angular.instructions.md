...
- **Primary (complete docs):** {{DOCS_BASE_URL}}/llms-angular-full.txt
- **TOC (links to .md pages):** {{DOCS_BASE_URL}}/llms-angular.txt
- **Individual pages:** `{{DOCS_BASE_URL}}/docs/angular/{section}/{page}.md`
