...
formatting will be defined by the [theme](../theming/built-in-themes).
...
when [filtering](../select/api#opt-filter) is turned on and there are no results for the searched text.
...
Placeholder text for the filter input, when [filtering](../select/api#opt-filter) is turned on.
...
[custom language module](../core-concepts/localization#creating-custom-language-module).
...
Title for the newly created event with the [dragToCreate](../eventcalendar/api#opt-dragToCreate) and the
[clickToCreate](../eventcalendar/api#opt-clickToCreate) action.
...
When selecting a range, it specifies the placeholder text for the end value under the [end label](../datepicker/api#opt-showRangeLabels).
...
When selecting a range, it specifies the text of the [end label](../datepicker/api#opt-showRangeLabels).
...
When selecting a range, it specifies the placeholder text for the start value under the [start label](../datepicker/api#opt-showRangeLabels).
...
When selecting a range, it specifies the text of the [start label](../datepicker/api#opt-showRangeLabels).
