...
description: Switch from the Mobiscroll trial package to the licensed version in your JavaScript project — replace the trial with the licensed npm package.
---
