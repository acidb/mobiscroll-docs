...
## Templating
The display of Calendar can be customized with different [solts](#slots) functions.

### Label and content
There are two approaches you can take:
- Only customize the content of the labels - for this you will want to use the [labelContent](#slot-labelContent) option.
- Fully customize how the labels look - use the [label](#slot-label) option.
...
- Full event customization - by using the [eventContent](#slot-eventContent) option
- Content customization - with the [event](#slot-event) option
