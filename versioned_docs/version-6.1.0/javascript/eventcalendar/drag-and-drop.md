...
title: Drag & drop
description: Enable drag-and-drop event creation, moving, and resizing in the Mobiscroll Eventcalendar and Timeline views for JavaScript.
---
...
### Third party dragging libraries {#third-party-dragging-support}
...
### Drop to third party drag&drop list {#third-party-dropping-support}
