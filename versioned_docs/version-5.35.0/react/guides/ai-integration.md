...
|:---|:---|:---|
| **Cursor** | `llms-react-full.txt` via @docs | Option A: `.mdc` rules file — Option B: extended rule files + MCP |
...
```
What props does the Eventcalendar component accept?
How do I configure a weekly timeline view in Mobiscroll React?
What are the TypeScript types for Mobiscroll calendar events?
```
