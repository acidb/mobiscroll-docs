...
| File | Description |
|:---|:---|
| `llms-v5-javascript-full.txt` | Complete JavaScript documentation |
| `llms-v5-javascript.txt` | JavaScript table of contents (links to individual pages) |
...
| File | Framework |
|:---|:---|
| <DocsLink path="5.35.0/mobiscroll-javascript-v5.mdc" download /> | JavaScript |
...
|:---|:---|:---|:---|
| **Cursor** | `llms-v5-javascript-full.txt` via @docs | `.mdc` file | — |
| **GitHub Copilot** | `.mdc` file (contains doc URLs) | `.mdc` file | — |
| **Claude Code** | `llms-v5-javascript-full.txt` | `CLAUDE.md` | `CLAUDE.md` |
...
| Framework | Name | URL |
|:---|:---|:---|
| JavaScript | Mobiscroll JavaScript | <DocsUrl path="5.35.0/llms-v5-javascript-full.txt" /> |
...
Download the <DocsLink path="5.35.0/mobiscroll-javascript-v5.mdc" download><code>mobiscroll-javascript-v5.mdc</code></DocsLink> file for your framework and place it in your project's `.cursor/rules/` directory:
...
Download the <DocsLink path="5.35.0/mobiscroll-javascript-v5.mdc" download><code>mobiscroll-javascript-v5.mdc</code></DocsLink> file for your framework and place it at the root of your project or alternatively [copy it's content](#rules-files-mdc) to the rules files under the `.github/` directory:
...
|   └── instructions/
|       └── javascript-logic.instructions.md <-- Specific rules
├── src/
├── package.json
└── ...
```
...
If you don't already have a `CLAUDE.md` in your project root, download <DocsLink path="5.35.0/javascript/CLAUDE.md" download><code>CLAUDE.md</code></DocsLink> and place it there. If you already have one, copy the contents into your existing file instead — see [File contents](#file-contents) below.
...
Claude Code will fetch `llms-v5-javascript-full.txt` automatically based on the detected framework. No manual registration is needed.
...
**Fix:** Verify that you have the correct `.mdc` file in place. For JavaScript, use `mobiscroll-javascript.mdc`, not a different framework's `.mdc` file. In Cursor, check that the registered @docs source points to `5.35.0/llms-v5-javascript-full.txt`.
...
| File | URL |
|:---|:---|
| JavaScript | <DocsUrl path="5.35.0/llms-v5-javascript.txt" /> |
| JavaScript (full) | <DocsUrl path="5.35.0/llms-v5-javascript-full.txt" /> |

### Rules files

| File | URL |
|:---|:---|
| JavaScript rules | <DocsLink path="5.35.0/mobiscroll-javascript-v5.mdc" download /> |

### Routing file

| File | URL |
|:---|:---|
| Claude Code context | <DocsLink path="5.35.0/javascript/CLAUDE.md" download /> |
...
<FileBlock src="5.35.0/javascript/CLAUDE.md" />
</details>
...
<FileBlock src="5.35.0/mobiscroll-javascript-v5.mdc" />
</details>
