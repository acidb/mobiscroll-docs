...
- `--mbsc-popup-bg-color`: Popup background color (mapped from alert background)
- `--mbsc-popup-text-color`: Popup text color (mapped from alert text)
...
- `--mbsc-popup-bg-color`: Popup background color (mapped from alert/notification background)
