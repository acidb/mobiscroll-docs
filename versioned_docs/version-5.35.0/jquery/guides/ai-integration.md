...
| File | Description |
|:---|:---|
| `llms-v5-jquery-full.txt` | Complete jQuery documentation |
| `llms-v5-jquery.txt` | jQuery table of contents (links to individual pages) |
...
| File | Framework |
|:---|:---|
| <DocsLink path="5.35.0/mobiscroll-jquery-v5.mdc" download /> | jQuery |
...
|:---|:---|:---|:---|
| **Cursor** | `llms-v5-jquery-full.txt` via @docs | `.mdc` file | — |
| **GitHub Copilot** | `.mdc` file (contains doc URLs) | `.mdc` file | — |
| **Claude Code** | `llms-v5-jquery-full.txt` | `CLAUDE.md` | `CLAUDE.md` |
...
| Framework | Name | URL |
|:---|:---|:---|
| jQuery | Mobiscroll jQuery | <DocsUrl path="5.35.0/llms-v5-jquery-full.txt" /> |
...
Download the <DocsLink path="5.35.0/mobiscroll-jquery-v5.mdc" download><code>mobiscroll-jquery-v5.mdc</code></DocsLink> file for your framework and place it in your project's `.cursor/rules/` directory:
...
Download the <DocsLink path="5.35.0/mobiscroll-jquery-v5.mdc" download><code>mobiscroll-jquery-v5.mdc</code></DocsLink> file for your framework and place it at the root of your project or alternatively [copy it's content](#rules-files-mdc) to the rules files under the `.github/` directory:
...
Claude Code will fetch `llms-v5-jquery-full.txt` automatically based on the detected framework. No manual registration is needed.
...
**Fix:** Verify that you have the correct `.mdc` file in place. For jQuery, use `mobiscroll-jquery.mdc`, not a different framework's `.mdc` file. In Cursor, check that the registered @docs source points to `5.35.0/llms-v5-jquery-full.txt`.
...
| File | URL |
|:---|:---|
| jQuery | <DocsUrl path="5.35.0/llms-v5-jquery.txt" /> |
| jQuery (full) | <DocsUrl path="5.35.0/llms-v5-jquery-full.txt" /> |

### Rules files

| File | URL |
|:---|:---|
| jQuery rules | <DocsLink path="5.35.0/mobiscroll-jquery-v5.mdc" download /> |
...
<FileBlock src="5.35.0/mobiscroll-jquery-v5.mdc" />
</details>
