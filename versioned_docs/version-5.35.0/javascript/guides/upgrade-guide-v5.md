...
We renamed the `showOnTap` option to [showOnClick](/javascript/select/api#opt-showOnClick) and the `showOnOverlayTap` option to [showOnOverlayClick](/5.35.0/javascript/select/api#opt-showOnOverlayClick) for the sake of simplicity and to make it more obvious.
