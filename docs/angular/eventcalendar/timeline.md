...
The [`externalDrag`](./api#opt-externalResourceDrag) option allows resources to be dragged out of the timeline view and dropped onto another instance of the Timeline or any [Dropcontainer](drag-and-drop#dropcontainer).  
