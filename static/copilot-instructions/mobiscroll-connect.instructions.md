...
- **Primary (complete docs):** {{DOCS_BASE_URL}}/llms-connect-full.txt
- **TOC (links to .md pages):** {{DOCS_BASE_URL}}/llms-connect.txt
- **Individual pages:** `{{DOCS_BASE_URL}}/connect/{section}/{page}.md`
