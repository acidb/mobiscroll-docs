...
slug: /angular
description: 'Mobiscroll for Angular — a standalone UI component library for scheduling, date picking, forms, and notifications with no framework dependency.'
---
...
Mobiscroll supports Angular version 9 and up to Angular 21 and requires TypeScript 4 or newer.
:::
