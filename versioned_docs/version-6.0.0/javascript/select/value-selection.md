...
sidebar_position: 4
description: Control value selection behavior in the Mobiscroll Select for JavaScript — single, multiple, pre-selected values, and programmatic value updates.
---
