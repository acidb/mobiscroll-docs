...
description: 'Localize Mobiscroll jQuery components — configure locale, date/time formats, RTL direction, and custom text labels.'
---
...
import $ from 'jquery';
import { MbscLocale } from '@mobiscroll/jquery';
import '@mobiscroll/jquery/dist/css/mobiscroll.min.css';
