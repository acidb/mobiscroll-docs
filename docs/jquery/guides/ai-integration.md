...
description: 'Set up AI coding assistants — Claude Code, Cursor, and GitHub Copilot — with Mobiscroll jQuery docs and behavior rules to generate accurate, framework-specific component code.'
---
