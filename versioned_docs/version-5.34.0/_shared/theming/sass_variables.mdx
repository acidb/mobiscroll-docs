...
<CodeBlock language="scss">{`@use '@mobiscroll/${props.framework}/dist/css/mobiscroll.scss' with (
...
<CodeBlock language="scss">{`// Override the variables BEFORE the scss file import, otherwise they won't take effect
$mbsc-ios-accent: #e61d2a;
$mbsc-material-accent: #e61d2a;
$mbsc-windows-accent: #e61d2a;

@import '@mobiscroll/${props.framework}/dist/css/mobiscroll.scss';`}</CodeBlock>
