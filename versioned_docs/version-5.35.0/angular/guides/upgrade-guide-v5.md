...
We renamed the `showOnTap` option to [showOnClick](/angular/select/api#opt-showOnClick) and the `showOnOverlayTap` option to [showOnOverlayClick](/5.35.0/angular/select/api#opt-showOnOverlayClick) for the sake of simplicity and to make it more obvious.
