...
| File | Format | For |
|:---|:---|:---|
| <DocsLink path="mobiscroll-react.mdc" download /> | Cursor rule file | Cursor, GitHub Copilot |
...
Download the <DocsLink path="mobiscroll-react.mdc" download><code>mobiscroll-react.mdc</code></DocsLink> file and place it at the root of your project, or copy [its content](#rules-files-mdc) into your `.github/` instruction files:
